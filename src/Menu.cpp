...
Menu::Menu()
  ...
  // Buttons
  start_easy.SetImages("images/buttons/start_easy.png",
  ...
  start_medium.SetImages("images/buttons/start_medium.png",
  ...
  start_hard.SetImages("images/buttons/start_hard.png",
  ...
  quit.SetOnClick([this]() { set_next_state(STATE_EXIT); });
}
